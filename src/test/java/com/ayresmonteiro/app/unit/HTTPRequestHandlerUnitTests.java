...
public class HTTPRequestHandlerUnitTests {
    ...
    @Test
    public void assertIfHeadersObjectAreSetAfterSetContentType() {
        Map<String, String> headers = HTTPRequestHandler.addContentTypeJSONToHeaders(null);
    ...
    @Test
    public void assertIfContentTypeXMLHeaderWasNotOverwritedAfterSetAccept() {
        Map<String, String> headers = new HashMap<String, String>() {
            {
                put("Content-Type", "application/xml");
            }
    ...
    @Test
    public void assertIfAcceptXMLHeaderWasNotOverwritedAfterSetContentType() {
        Map<String, String> headers = new HashMap<String, String>() {
            {
                put("accept", "application/xml");
            }
